...
if __name__ == '__main__':
    ...
    img = cv2.imread('C:/Users/Dell/Desktop/CV final project/xray.png',0)
    # print(img)
    # img = np.asarray(img, dtype='float')
    # print(img)
    imgcolor= cv2.imread('C:/Users/Dell/Desktop/CV final project/xray.png')
    # imgcolor = imgcolor.astype(float)
    sigma=3
    print('part 0')
    ...
    for i in range(0,len(pts)):
        # print('part '+ str(i))
        imgcolor[pts[i][0]][pts[i][1]][0]=255.0
        imgcolor[pts[i][0]][pts[i][1]][1]=0.0
        imgcolor[pts[i][0]][pts[i][1]][2]=0.0
    cv2.imwrite('C:/Users/Dell/Desktop/CV final project/xrayoutput.png', imgcolor)
